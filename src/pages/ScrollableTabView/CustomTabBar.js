  ...
  render() {
    return (
      <View style={Styles.tabbar}>
        <TouchableOpacity>
          <Image source={require('../../../assets/search.png')} style={[Styles.icon, {marginLeft: 5}]}/>
        </TouchableOpacity>
        ...
        <TouchableOpacity source={require('../../../assets/shoppingcar.png')}>
          <Image source={require('../../../assets/shoppingcar.png')} style={[Styles.icon, {marginRight: 5}]} />
        </TouchableOpacity>
      </View>
    )
  }
